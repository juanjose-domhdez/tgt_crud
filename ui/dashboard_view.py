        ...
        return ft.Column(
            controls=[
                ...
                ft.ListTile(
                    ...
                    title=ft.Text(
                        "Inicio",
                        color=COLOR_TEXT_PRIMARY if actual in ["dashboard", "inicio"] else COLOR_TEXT_SECONDARY,
                        weight=ft.FontWeight.BOLD if actual in ["dashboard", "inicio"] else ft.FontWeight.NORMAL,
                    ),
